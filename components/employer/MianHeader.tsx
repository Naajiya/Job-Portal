...
function MianHeader() {
    return (
        <div className='p-3 px-4 flex justify-between items-center bg-slate-100'>
            <div className=''>
            ...
            <div className='flex items-center gap-5'>
                <div className='flex gap-4 font-semibold'>
                    ...
                    <p className='cursor-pointer'>Manage Jobs</p>
                    <p className='cursor-pointer'>Applicant</p>
                </div>
                <div className='action'>
                    <button className='p-1 rounded font-semibold px-3 bg-blue-700 text-white'>Login</button>
                </div>
            </div>
        </div>
    )
