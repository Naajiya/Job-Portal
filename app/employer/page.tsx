...
function page() {
    return (
        <div className='h-screen'>
            ...
            <div className='w-full p-5 flex flex-wrap gap-5 items-center justify-center'>
                ...
                <div className='h-30 w-80 p-3 hover:tracking-wide shadow rounded gap-3 border-slate-200 border flex items-center'>
