    ...
    return (
        <div className='w-full h-screen bg-black flex'>
            <div className='hidden md:flex md:w-1/5 h-full bg-blue-900 text-white p-3 flex-col justify-between'>
                <div className='flex-col'>
                    <div className='flex items-center justify-between'>
                        <div className='flex items-center justify-center gap-3'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" className="size-6 bg-white rounded-2xl ">
                            ...
                            <div className=''>
                                ...
                                <p className='text-xs font-light'>Admin Panel</p>
                            </div>
                        </div>
                    ...
                    <div className='admin-settings mt-5'>
                        {
                            sideBarFields.length > 0 && sideBarFields.map((item, id) => (
                                <div key={id} onClick={() => setActiveTab(item?.id)} className={`flex justify-between items-center rounded-xl p-2 ${activeTab == item?.id && 'bg-blue-700'} `}>
                                    <div className='flex justify-center items-center gap-3'>
                                        {item.icon}
                                        <h3 className=' text-white font-medium'>{item?.title}</h3>
                                    </div>
                                    {activeTab != item?.id && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                ...
                <div>
                    <button className='border border-slate-400 w-full py-2 font-medium flex items-center rounded justify-center gap-2 '>
...
{/* <div onClick={() => setActiveTab('jobs')} className={`flex justify-between items-center rounded-xl cursor-pointer p-2 ${activeTab == 'jobs' && 'bg-blue-700'} `}>
                        <div className='flex justify-center items-center gap-3'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 0 0 .75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 0 0-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0 1 12 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 0 1-.673-.38m0 0A2.18 2.18 0 0 1 3 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 0 1 3.413-.387m7.5 0V5.25A2.25 2.25 0 0 0 13.5 3h-3a2.25 2.25 0 0 0-2.25 2.25v.894m7.5 0a48.667 48.667 0 0 0-7.5 0M12 12.75h.008v.008H12v-.008Z" />
                            </svg>
                            <h3 className='text-white font-medium'>Jobs</h3>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                            <path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                        </svg>
